...
a flat list [pop1 expected data, pop2 expected data, pop3 expected data]. With this, you can pass into expected in chisquare() to properly calculate a homogeneity test. 
